...
static const char* cn_strings[] = {
    ...
    [STR_M09] = "M09 周期启动信号",
    [STR_M091] = "启动时间(s)",
    [STR_M10] = "M10 启动信号为工作中",
    [STR_M11] = "M11 架上无料输出寸动",
    [STR_M12] = "M12 自动换料1",
    [STR_M13] = "M12 防震用于工作中",
    ...
    [STR_PROCESS_PAGE] = "工艺页面",
    [STR_COMMON_SETTINGS] = "常用设置",
    [STR_SPECIAL_SETTINGS] = "特殊设置",
    [STR_IO_DEBUG] = "I/O调试",
    [STR_PART_NUMBER] = "零件号",
    [STR_PART1] = "零件1",
    [STR_PART2] = "零件2",
    ...
    [STR_PART5] = "零件5",
    [STR_PART6] = "零件6",
    [STR_WORKPIECE_LENGTH] = "工件长度",
    [STR_CLAMP_OPEN_FORCE] = "夹开推力",
    [STR_CLAMP_OPEN_SPEED] = "夹开速度",
    [STR_CLAMP_CLOSE_FORCE] = "夹闭推力",
    [STR_CLAMP_CLOSE_SPEED] = "夹闭速度",
    [STR_OIL_PUMP_FREQUENCY] = "油泵频率",
    [STR_IO_TYPE_SETTINGS] = "IO类型设置",
    [STR_IO_TEST_FUNCTION] = "IO测试功能",
    [STR_SYNC_RESOLUTION] = "同步分辨率",
    [STR_START_TIME] = "启动时间",
    [STR_TIME_YEAR] = "时间(年)",
    [STR_TIME_MONTH] = "时间(月)",
    [STR_TIME_DAY] = "时间(日)",
    [STR_TIME_HOUR] = "时间(时)",
    [STR_TIME_MINUTE] = "时间(分)",
    [STR_NORMALLY_OPEN] = "常开",
    [STR_NORMALLY_CLOSED] = "常闭",
    [STR_FLASH] = "闪烁",
    [STR_STEADY_ON] = "常亮",
    [STR_LATHE_CLAMP_OPEN_TYPE] = "车床夹开类型",
    [STR_LATHE_FAULT_TYPE] = "车床故障类型",
    [STR_ALLOW_BACKWARD_TYPE] = "允许后退类型",
    [STR_FORCE_PAUSE_TYPE] = "推力暂停类型",
    [STR_COVER_OPEN_AT_POS_TYPE] = "开盖到位类型",
    [STR_COVER_CLOSE_AT_POS_TYPE] = "闭盖到位类型",
    [STR_REMAIN_MATERIAL_TYPE] = "残材检知类型",
    [STR_CUT_END_SENSOR_TYPE] = "切端检知类型",
    [STR_HOME_SENSOR_TYPE] = "原点检知类型",
    [STR_JOG_TEST] = "寸动测试",
    [STR_FAULT_TEST] = "异常测试",
    [STR_MATERIAL_SHORTAGE_TEST] = "材欠测试",
    [STR_START_TEST] = "启动测试",
    [STR_OPEN_COVER_TEST] = "开盖测试",
    [STR_CLOSE_COVER_TEST] = "闭盖测试",
    [STR_CLAMP_SEAT_TEST] = "夹料座测试",
    [STR_CUT_END_DISCHARGE_TEST] = "切端下料测试"};
...
static const char* en_strings[] = {
    ...
    [STR_PROCESS_PAGE] = "Process Page",
    [STR_COMMON_SETTINGS] = "Common Settings",
    [STR_SPECIAL_SETTINGS] = "Special Settings",
    [STR_IO_DEBUG] = "I/O Debug",
    [STR_PART_NUMBER] = "Part No.",
    [STR_PART1] = "Part 1",
    [STR_PART2] = "Part 2",
    [STR_PART3] = "Part 3",
    [STR_PART4] = "Part 4",
    [STR_PART5] = "Part 5",
    [STR_PART6] = "Part 6",
    [STR_WORKPIECE_LENGTH] = "Workpiece Length",
    [STR_CLAMP_OPEN_FORCE] = "Clamp Open Force",
    [STR_CLAMP_OPEN_SPEED] = "Clamp Open Speed",
    [STR_CLAMP_CLOSE_FORCE] = "Clamp Close Force",
    [STR_CLAMP_CLOSE_SPEED] = "Clamp Close Speed",
    [STR_OIL_PUMP_FREQUENCY] = "Oil Pump Freq",
    [STR_IO_TYPE_SETTINGS] = "I/O Type",
    [STR_IO_TEST_FUNCTION] = "I/O Test",
    [STR_SYNC_RESOLUTION] = "Sync Resolution",
    [STR_START_TIME] = "Start Time",
    [STR_TIME_YEAR] = "Time (Year)",
    [STR_TIME_MONTH] = "Time (Month)",
    [STR_TIME_DAY] = "Time (Day)",
    [STR_TIME_HOUR] = "Time (Hour)",
    [STR_TIME_MINUTE] = "Time (Min)",
    [STR_NORMALLY_OPEN] = "NO",
    [STR_NORMALLY_CLOSED] = "NC",
    [STR_FLASH] = "Flash",
    [STR_STEADY_ON] = "Steady",
    [STR_LATHE_CLAMP_OPEN_TYPE] = "Lathe Clamp Open",
    [STR_LATHE_FAULT_TYPE] = "Lathe Fault",
    [STR_ALLOW_BACKWARD_TYPE] = "Allow Backward",
    [STR_FORCE_PAUSE_TYPE] = "Force Pause",
    [STR_COVER_OPEN_AT_POS_TYPE] = "Cover Open Pos",
    [STR_COVER_CLOSE_AT_POS_TYPE] = "Cover Close Pos",
    [STR_REMAIN_MATERIAL_TYPE] = "Remnant Sensor",
    [STR_CUT_END_SENSOR_TYPE] = "Cut End Sensor",
    [STR_HOME_SENSOR_TYPE] = "Home Sensor",
    [STR_JOG_TEST] = "Jog Test",
    [STR_FAULT_TEST] = "Fault Test",
    [STR_MATERIAL_SHORTAGE_TEST] = "Shortage Test",
    [STR_START_TEST] = "Start Test",
    [STR_OPEN_COVER_TEST] = "Open Cover Test",
    [STR_CLOSE_COVER_TEST] = "Close Cover Test",
    [STR_CLAMP_SEAT_TEST] = "Clamp Seat Test",
    [STR_CUT_END_DISCHARGE_TEST] = "Cut End Out Test"};
